...
public class _04_Operator4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(김치찌개 || 계란말이 || 제육볶음); //하나라도 true이면 true || -> 또는
        System.out.println(김치찌개 && 계란말이 && 제육볶음); // 모두 true 이면 ture && -> 그리고


        // And 연산
        System.out.println((5 > 3) && (3 > 1)); // 5는 3보다 크고, 3은 1보다 크다 (true)
        System.out.println((5 > 3) && (3 < 1)); // 5논 3보다 크고, 3은 1보가 작다 (false)
